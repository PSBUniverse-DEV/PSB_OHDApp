/**
 * Client Component — OhdView.jsx
 *
 * Runs in the browser. All UI, hooks, and interaction go here.
 *
 * PATTERN:
 *   1. Create a custom hook (useOhd) at the top for state & logic.
 *   2. In the default export, call the hook and render your UI.
 *   3. Import helpers from "../data/ohd.data" (forms, mappers, constants).
 *   4. Import server actions from "../data/ohd.actions" (save, delete).
...
export default function OhdView(/* { items } */) {
